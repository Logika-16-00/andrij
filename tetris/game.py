...
gemeovertext = Picture('gemeover.png',380,200,10,10)
esc = Picture('esc.png',380,320,10,10)
score = Picture('score.png',350,50,10,10)
timeimg = Picture('timeimg.png',560,50,10,10)
